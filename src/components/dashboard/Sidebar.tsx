...
const Sidebar = () => {
  return (
    <ul className=" flex gap-2 justify-between fixed bg-white rounded-t-xl h-20 p-2 bottom-0 w-full  border-r-2 sm:rounded-none sm:justify-normal sm:flex-col sm:static sm:p-8 sm:pr-2 sm:h-screen">
